...
func (c *CLI) send(from, to string, amount int, nodeID string, mineNow bool) {
...
func (c *CLI) createBlockchain(address, nodeID string) {
...
func (c *CLI) getBalance(address, nodeID string) {
	if !ValidateAddress(address) {
		log.Panic("ERROR: Address is not valid")
	}
	bc := GetBlockchain(nodeID)
...
func (c *CLI) startNode(nodeID, minerAddress string) {
